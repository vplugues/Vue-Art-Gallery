        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel filterable">
                    ...
                    <div class="panel-body">
                        <table data-toggle="table" data-sort-name="age" data-sort-order="desc" data-pagination="true" data-search="true" data-height="400" id="table3">
                            <thead>
                                <tr>
...
import bootstrap_table from "../vendors/bootstrap-table/dist/bootstrap-table.min.js";
export default {
...
<style src="../vendors/bootstrap-table/dist/bootstrap-table.min.css"></style>
