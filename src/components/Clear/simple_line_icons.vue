                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <form role="form">
                            ...
                            <div class="input-group">
                                ...
                                <input type="range" name="icon-size" id="icon-size" class="form-control" min="24" max="40" value="24">
                ...
                <div class='row'>
                    <div class='col-xs-12'>
                        ...
                        <div class="text-center">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-user-following icons"></i><span class="name">user-following</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-options-vertical icons"></i><span class="name">options-vertical</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-arrow-up-circle icons"></i><span class="name">arrow-up-circle</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-arrow-left-circle icons"></i><span class="name">arrow-left-circle</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-arrow-down-circle icons"></i><span class="name">arrow-down-circle</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-screen-smartphone icons"></i><span class="name">screen-smartphone</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-screen-desktop icons"></i><span class="name">screen-desktop</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-game-controller icons"></i><span class="name">game-controller</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-envelope-letter icons"></i><span class="name">envelope-letter</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-size-fullscreen icons"></i><span class="name">size-fullscreen</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-music-tone-alt icons"></i><span class="name">music-tone-alt</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-control-rewind icons"></i><span class="name">control-rewind</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-control-forward icons"></i><span class="name">control-forward</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-cloud-download icons"></i><span class="name">cloud-download</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-magnifier-remove icons"></i><span class="name">magnifier-remove</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-social-twitter icons"></i><span class="name">social-twitter</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-social-facebook icons"></i><span class="name">social-facebook</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-social-instagram icons"></i><span class="name">social-instagram</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-social-linkedin icons"></i><span class="name">social-linkedin</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-social-pinterest icons"></i><span class="name">social-pinterest</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-social-dribbble icons"></i><span class="name">social-dribbble</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-social-behance icons"></i><span class="name">social-behance</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-social-foursqare icons"></i><span class="name">social-foursqare</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-social-soundcloud icons"></i><span class="name">social-soundcloud</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-social-spotify icons"></i><span class="name">social-spotify</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                            ...
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-social-youtube icons"></i><span class="name">social-youtube</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-social-dropbox icons"></i><span class="name">social-dropbox</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
                                    <i class="icon-social-vkontakte icons"></i><span class="name">social-vkontakte</span>
                                </div>
                            </div>
                            <div class="icon-preview-box col-xs-12 col-sm-4 col-md-3 col-lg-3">
                                <div class="preview">
