                    ...
                    <div class='col-xs-12'>
                        <section id="web-application">
                            ...
                            <div class="iconoptions text-center">
                                ...
                                <button class="btn btn-info btn-block" data-faclass="fa-flip-horizontal">Flip Horizontally
                                </button>
                                <button class="btn btn-info btn-block" data-faclass="fa-flip-vertical">Flip Vertically
                                </button>
                                <h4>Rotate</h4>
                                <div class="btn-group">
