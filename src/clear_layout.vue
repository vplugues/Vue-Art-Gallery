...
<script>
import clear_header from "./components/layout/Clear/clear_header";
import left_side from "./components/layout/Clear/left-side";
import right_side from "./components/layout/Clear/right-side";
